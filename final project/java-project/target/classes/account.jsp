...
<div class="container">
    ...
    <h1 class="text-center mt-3">${requestScope.user.clientName} ${requestScope.user.surname}</h1>
    ...
    <div class="container mb-4">
        <div class="row mb-2">
            ...
            <div class="col-2 themed-grid-col header font-weight-bold">Tariff Plan Name</div>
            <div class="col-2 themed-grid-col header font-weight-bold">Start date</div>
            <div class="col-2 themed-grid-col header font-weight-bold">End date</div>
        ...
        <c:forEach var="subscription" items="${requestScope.subscriptions}">
            <div class="row mb-2 bg-info">
                ...
                <div class="col-2 themed-grid-col"><u>${subscription.tariffPlan.tariffPlanName}</u></div>
                <div class="col-2 themed-grid-col">${subscription.startDate}</div>
                <div class="col-2 themed-grid-col">${subscription.endDate}</div>
                <div class="col-2 themed-grid-col">${subscription.tariffPlan.price}$</div>
            </div>
        </c:forEach>
    </div>
